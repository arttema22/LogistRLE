                    ...
                    <div class="col">
                        ...
                        <div class="form-floating mb-3">
                            <input type="date" name="date-route" id="date-route" placeholder="Дата маршрута"
                                class="form-control form-control-lg" value="{{ old('date-route') }}">
                            ...
                            @else
                                <div class="alert alert-danger" role="alert">
                                    В системе нет плательщиков. Для начала работы необходимо <a
                                        href="{{ route('directory.payers-new') }}" class="alert-link">заполнить список
                                        плательщиков</a>.
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="custom-route" style="display: none">
                                    <!--Пункт погрузки -->
                                    <div class="form-floating mb-3">
                                    ...
                                    <!-- Длина маршрута -->
                                    <div class="form-floating mb-3">
                                        <input type="number" min="1" max="5000" name="route-length"
                                            id="route-length" placeholder="Длина маршрута"
                                            class="form-control form-control-lg" value="{{ old('route-length') }}">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                        ...
                                        @else
                                            <div class="alert alert-danger" role="alert">
                                                В системе нет услуг. Для начала работы необходимо <a
                                                    href="{{ route('directory.services-new') }}"
                                                    class="alert-link">заполнить список услуг</a>.
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <textarea class="form-control" name="service-comment-1" id="service-comment-1" rows="3"></textarea>
                            ...
                            <div class="row one-service-2">
                                ...
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <textarea class="form-control" name="service-comment-2" id="service-comment-2" rows="3"></textarea>
                            ...
                            <div class="row one-service-3">
                                ...
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <textarea class="form-control" name="service-comment-3" id="service-comment-3" rows="3"></textarea>
                            ...
                            <div class="row one-service-4">
                                ...
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <textarea class="form-control" name="service-comment-4" id="service-comment-4" rows="3"></textarea>
                            ...
                            <div class="row one-service-5">
                                ...
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <textarea class="form-control" name="service-comment-5" id="service-comment-5" rows="3"></textarea>
                            ...
                            <div class="row one-service-6">
                                ...
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <textarea class="form-control" name="service-comment-6" id="service-comment-6" rows="3"></textarea>
