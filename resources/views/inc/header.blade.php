            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                @if (Auth::check())
                    <ul class="navbar-nav me-auto mb-2 mb-md-0">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{ route('dashboard') }}">Главная</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false">Маршруты</a>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="{{ route('routes.create') }}">Новый маршрут</a></li>
                                <li><a class="dropdown-item" href="{{ route('routes.list') }}">Маршруты</a></li>
                                <li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="{{ route('refilling.create') }}">Новая заправка</a>
                                </li>
                                <li><a class="dropdown-item" href="{{ route('refilling.list') }}">Заправки</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item" href="{{ route('refilling.archive') }}">Архив заправок</a>
                                </li>
                                @cannot('is-driver')
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="{{ route('salary.create') }}">Новое начисление</a>
                                </li>
                                <li><a class="dropdown-item" href="{{ route('salary.list') }}">Начисления</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item" href="{{ route('salary.archive') }}">Выплаты</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                    ...
                    <a class="btn btn-link"
                        href="{{ route('user.edit', Auth::user()->id) }}">{{ Auth::user()->profile->FullName }}</a>
